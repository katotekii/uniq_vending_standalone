Locales['en'] = {
    ...
    context = {
        ...
        stock = 'Vending Stock',
        item_desc = 'Price: $%s | Stock: %s',
        new_item = 'Add new item',
        how_much = 'How much you would like to buy?',
        select_item = 'Select Item',
        amount = 'Amount',
        max = 'Max: %s',
        max_can_put = 'Max you can put is %s',
        current = 'Current',
        edit_item = 'Edit Item',
        rem_item = 'Remove Item',
        update_price = 'Update Price',
        w_money = 'Withdaw Money',
        d_money = 'Deposit Money',
